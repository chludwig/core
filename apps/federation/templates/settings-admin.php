...
<div id="ocFederationSettings" class="section">
	...
	<em>ownCloud Federation allows you to connect with other trusted ownClouds to exchange the user directory.</em>
	<em>For example this will be used to auto-complete external users for federated sharing.</em>
